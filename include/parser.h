...
#define _LINE_LENGTH_MAX_ 2048 /**< size of the string read in each line of the file (extra characters not taken into account) */
#define _ARGUMENT_LENGTH_MAX_ 2048 /**< maximum size of each argument (name or value), including the final null character */
